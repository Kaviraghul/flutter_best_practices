...
import 'package:flutter_best_practices/presentation/resources/colors_manager.dart';
...
class AppStyle {
  ...
  /// text
  late final Text text = Text(scale);
...
class Text {
  ...
  final Map<String, TextStyle> _contentFonts = {
    'en': const TextStyle(fontFamily: 'Raleway', fontFeatures: const [
...
@immutable
class Times {
  final Duration fast = const Duration(microseconds: 300);
  final Duration med = const Duration(microseconds: 300);
  final Duration slow = const Duration(microseconds: 300);
  final Duration pageTransition = const Duration(microseconds: 300);
}
